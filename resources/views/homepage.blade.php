                ...
                <div class="col-md-4 d-flex justify-content-center align-self-stretch ftco-animate">
                  <div class="services w-100 text-center">
                    ...
                    <div class="text w-100 text-center mx-auto m-auto">
                      <h3 class="heading mb-2 text-center">Reserve Your Book</h3>
                    </div>
                  </div>
                </div>
              </div>
              <p class="text-center mt-5"><a href="#buku"
                  class="btn text-center mx-auto m-auto ml-auto btn-primary py-3 px-4">Reserve Your Favorit Book</a>
              </p>
            </div>
          </div>
        </div>
